...
class _ListUsersState extends State<ListUsers> {
  ...
  Future<void> filterUsers(String variable) async {
    try {
      List<UserModel>? allUsers = await UserService.getAllUsers();
      print("try");
      ...
      if (allUsers != null) {
        for( var user in allUsers!){
          if(user.email.contains(variable)|| user.lastName.contains(variable)||user.firstName.contains(variable)||user.phoneNumber.contains(variable)){
  ...
  Widget SearchField(BuildContext context) {
    return TextField(
      controller: searchController, // Connect the controller to the TextField
      onChanged: (value) {
